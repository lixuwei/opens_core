...
import com.core.common.util.MD5;
...
//                }
                ...
                if (userFromDb != null && userFromDb.getLoginPwd().equals(MD5.getMD5(user.getLoginPwd()))) {
                    ...
                    System.out.println("curUserFunctionList:"+curUserFunctionList.size());
                    System.out.println("tabUserFunctionList:"+tabUserFunctionList.size());
